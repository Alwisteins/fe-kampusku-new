...
import { RankTypeTab } from "./_components/rank-type-tab";
    ...
    <div class="mt-8 h-screen">
      <div class="flex flex-col items-center justify-center">
        <div class="flex items-center space-x-2">
          <h2 class="text-2xl font-bold text-prim-300">Peringkat</h2>
          <IconRankColor />
        </div>
        <p class="text-[#6B7280]">
          Nyari yang top rank? semangat ya belajarnya
        </p>
      </div>
      <div class="mt-6 flex justify-center">
        <RankTypeTab type={type.value} />
      </div>
        ...
        {cardData.map((card, index) => (
          ...
          >
            ...
            {type.value === "international" ? (
              <h1 class="text-3xl font-bold text-prim-300 group-hover:text-white">
                {card.international_rank}
              </h1>
            ) : (
              <h1 class="text-3xl font-bold text-prim-300 group-hover:text-white">
                {card.national_rank}
